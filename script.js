...
submitBtn.addEventListener("click", function () {
  ...
  // console.log(typeof infoPet.id);
  // console.log(typeof infoPet.name);
  // console.log(typeof infoPet.age);
  // console.log(typeof infoPet.type, infoPet.type);
  // console.log(typeof infoPet.length);
  // console.log(typeof infoPet.color);
  // console.log(typeof infoPet.breed);
  // console.log(typeof infoPet.vaccinated);
  // console.log(typeof infoPet.dewormed);
  // console.log(typeof infoPet.sterilized);
  // validata
